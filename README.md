...
| [`forge-sessions`](crates/forge-sessions) | What a view needs and nothing about how it renders: the inbound peer envelope parsing today, and the session records and reducers that belong here as they leave the TUI. Sits between the workspace and the views. |
