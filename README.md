...
| [`forge-web`](crates/forge-web) | The web view: the same core served as HTML over HTTP, in the process that owns the sessions. Never names `forge-workspace`, and starts no subsystem of its own. |
