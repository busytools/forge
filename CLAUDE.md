...
- Proactive memory: `~/.claude-*/projects/-Users-dev-Projects-forge/memory/`.
...
- Cross-project dispatch goes through the peer MCP
  ...
  Other project agents: aware, dotfiles, gateway-backend, data-modules,
  nf-core, stargate, web-api, architect.
