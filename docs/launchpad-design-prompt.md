...
│   ├─ forge   [x]     │                              │    ⎇ branch-name      │
│   ├─ hub-modules [x] │   user message ────►         │    +12 -5             │
│   └─ trader-cc       │                              │                       │
│                      │   < assistant streaming      │  TASKS · 2/5          │
│  Granite             │     reply >                  │    ✓ done one         │
│   ├─ core-v1  [x]    │                              │    ⠋ in progress      │
│                      │   ─────────────              │    ○ pending          │
│  Personal            │   > Type a prompt ▌          │                       │
│   └─ companies       │                              │  PROCESSES            │
│                      │  ─────────────────────────   │    ⠋ cargo · 64 MB    │
│  Subspace            │  Profile  Subspace           │    └─ rustc · 100 MB  │
│   └─ subspace [x]    │  Mode     Auto               │                       │
│                      │  Model    Opus 1M            │                       │
│                      │  Effort   Max                │                       │
│                      │  Ctx ▓▓▓▓▓▓░░ 70%            │                       │
│                      │  5h  ▓▓░░░░░░ 25%            │                       │
...
- The "Why this is a separate session" + open design questions in
  ...
  `~/.claude-personal/projects/-Users-vedhavyas-Projects-forge/memory/brief_launchpad_view.md`
