...
- **scope** - All three tiers ship: Wide (≥160) inline 40ch · Medium (120-159) inline 30ch with item truncation · Narrow (<120) top-bar icon + overlay.
