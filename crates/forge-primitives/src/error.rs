//! App-level error enum used across forge crates. Promoted from
//! `forge_tui::error` in Phase 0 of the MVVM refactor (#102) so
//! `forge_workspace::SessionUpdate::FatalError` can carry the
//! real type without a TUI dependency cycle.
