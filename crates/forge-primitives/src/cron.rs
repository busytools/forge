...
//! list persists to `<config_dir>/forge-cron.toml`; the scheduler
//! re-reads that file every tick so several forge processes sharing
//! one config dir agree on a single source of truth.
//!
