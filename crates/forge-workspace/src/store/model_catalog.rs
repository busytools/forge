...
//! [`forge_gateway::model_catalog`].

use anyhow::Context;
use redb::TableDefinition;

use super::Db;
pub use forge_gateway::model_catalog::CachedCatalog;
...
mod tests {
    ...
    use forge_gateway::model_catalog::CatalogModel;
        ...
        CachedCatalog {
            ...
            models: (0..models)
                .map(|index| CatalogModel {
                    ...
                    pricing: forge_gateway::model_catalog::CatalogPricing {
                        prompt: "0.0000014".to_owned(),
                        completion: "0.0000044".to_owned(),
                    },
                    supported_parameters: vec!["tools".to_owned()],
                    architecture: forge_gateway::model_catalog::CatalogArchitecture {
