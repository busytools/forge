...
pub enum WorkspaceError {
    ...
    #[error(
        "[projects.{project}.env] in forge.toml at {} names a project no [[orgs.projects]] declares; valid projects: {valid}",
        path.display()
    )]
    UnknownProjectEnv { path: PathBuf, project: String, valid: String },
