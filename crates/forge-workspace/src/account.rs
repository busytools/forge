...
//! pin of `[Gateway, Gateway1, Personal]` means "pick Gateway when
//! it's usable; if Gateway is at 100% or 429-throttled, fall through
//! to Gateway1; only reach Personal when both above are blocked."
//!
