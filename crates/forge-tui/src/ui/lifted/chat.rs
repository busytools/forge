...
use crate::ui::lifted::message::{self, SpinnerState};
use crate::ui::theme;
use ratatui::Frame;
...
fn msg_spinner(
    ...
    msg: &crate::state::messages::ChatMessage,
) -> SpinnerState {
...
fn measure_message_height(
    msg: &mut crate::state::messages::ChatMessage,
...
fn build_scrolled_render_data(
    ...
    let reduced_motion = app.prefers_reduced_motion_effective();
...
fn render_scrollbar_overlay(
    ...
    let Some(target) = crate::state::viewport::compute_scrollbar_geometry(
        content_height,
        viewport_height,
        viewport.scroll_pos,
    ) else {
...
fn emit_render_summary(
    ...
    let trace_state = crate::state::app::ChatRenderTraceState {
        width,
        content_height,
        viewport_height,
...
fn remember_render_trace_state(
    app: &mut App,
    trace_state: crate::state::app::ChatRenderTraceState,
) -> bool {
...
fn count_populated_cache_slots(messages: &[crate::state::messages::ChatMessage]) -> usize {
    messages
        .iter()
