...
//! Two-column list widget lifted from `claude-code-rust`. Used by
//! help / settings / picker views to render `key — description` rows
//! that wrap independently in each column.
