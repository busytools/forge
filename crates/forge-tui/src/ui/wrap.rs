...
//! Width-aware text wrapping primitives lifted from `claude-code-rust`.
//!
//! `display_width`, `wrap_styled_chunks`, `take_prefix_by_width` are
//! the workhorses used by markdown, document tables, and chat content
