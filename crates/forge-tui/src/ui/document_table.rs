...
//! Markdown table renderer lifted from `claude-code-rust`. Wraps
//! `pulldown-cmark` table events into a properly aligned grid with
...
mod tests {
    use super::*;
    // pretty_assertions removed; std assert_eq! works the same
