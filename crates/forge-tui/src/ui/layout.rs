...
//! Vertical layout primitive lifted from `claude-code-rust`.
//!
//! Computes `body / input_sep / todo / input / input_bottom_sep / help
//! / footer` rectangles. Switches to ultra-compact (no footer, no
//! todo) when terminal height is `< 8` rows.
