...
use crate::state::tool_call_info::InlineQuestion;
use crate::state::viewport::LayoutInvalidation as InvalidationLevel;
use crossterm::event::{KeyCode, KeyEvent, KeyModifiers};

fn focused_question(app: &App) -> Option<&InlineQuestion> {
...
fn question_selected_indices(question: &InlineQuestion) -> Vec<usize> {
    if question.prompt.multi_select {
