...
//! Per-block render cache lifted from claude-code-rust
...
impl BlockCache {
    ...
    pub fn store(&mut self, lines: Vec<ratatui::text::Line<'static>>) {
        self.store_with_policy(lines, *crate::cache_policy::default_cache_split_policy());
    }
    ...
    pub fn store_with_policy(
        ...
        policy: crate::cache_policy::CacheSplitPolicy,
    ) {
    ...
    pub fn store_for_width(&mut self, lines: Vec<ratatui::text::Line<'static>>, width: u16) {
        ...
        self.store_with_policy_and_width(lines, *crate::cache_policy::default_cache_split_policy());
    }
