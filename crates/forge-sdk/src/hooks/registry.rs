...
mod tests_hooks_registration {
    ...
    fn all_ten_hook_kinds_register_and_count() {
        ...
        let hooks = HooksBuilder::new()
            ...
            .user_prompt_submit(|_i: crate::UserPromptSubmitInput, _c| async move {
                HookDecision::allow()
            })
            .stop(|_i: crate::StopInput, _c| async move { HookDecision::passthrough() })
            .subagent_stop(
                |_i: crate::SubagentStopInput, _c| async move { HookDecision::passthrough() },
            )
            .subagent_start(|_i: SubagentStartInput, _c| async move { HookDecision::passthrough() })
            .pre_compact(
                |_i: crate::PreCompactInput, _c| async move { HookDecision::passthrough() },
            )
