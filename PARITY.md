...
| **Design-spec basis** | `~/.claude-subspace/plans/2026-04-21-forge-sdk-port-design.md` + `~/.claude-subspace/plans/2026-04-21-forge-sdk-m0-m1-plan.md` + `~/.claude-subspace/plans/2026-04-21-forge-sdk-m2-m3-plan.md` + `~/.claude-subspace/plans/2026-04-21-forge-sdk-m4-m7-plan.md` + `~/.claude-subspace/plans/2026-04-21-forge-sdk-corrections.md` (if present — apply before executing Plans 2/3). |
